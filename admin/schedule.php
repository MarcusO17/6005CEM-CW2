...
<body>
    ...
    <div class="container">
        <?php 
        $page = 'schedule'; // Set current page for menu highlighting
        include('menu.php'); 
        ?>
        <div class="dash-body">
                ...
                <tr>
                    <td colspan="4">
                        <div style="display: flex;margin-top: 40px;">
                            <div class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49);margin-top: 5px;">Create New Session</div>
        ...
        if ($action == 'add-session') {
            ...
            <div id="popup1" class="overlay">
                ...
                . '</td>
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Create New Session</p><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
            ...
            echo     '       </select><br><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="nop" class="form-label">Maximum Patient Capacity: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="number" name="nop" class="input-text" min="1" 
                                           placeholder="Maximum number of patients that can book this session" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label">
                                        <b>Current Bookings:</b> (' . $result12->num_rows . ' out of ' . $nop . ' slots)
                                    </label>
                                    <br><br>
                                </td>
                            </tr>
